...
import com.example.listatareas.database.TaskDao
...
class AddTaskActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        private val TAG = AddTaskActivity::class.simpleName
    }
    ...
    fun onSaveButtonClicked(){
        ...
        val taskEntry = TaskEntry(description = description,priority = prioridad,updateAt = Date())
        doAsync{
            if( mTaskId == DEFAULT_TASK_ID ){
